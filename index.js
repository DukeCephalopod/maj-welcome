(() => {
  ...
  const generatePreview = () => {
    ...
    const mjSupport = [
      "",
      `And of course we are happy to answer any questions ${you} might have! ${emoji} Type **‘mj-support’** (without quotes) in the chat and we'll be there to help as soon as we can. You'll get a confirmation that looks like this:`,
    ];
